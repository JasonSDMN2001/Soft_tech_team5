<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="devViewAllProjectsUnreg.aspx.cs" Inherits="WebApplication3.devViewAllProjectsUnreg" %>
...
<body>
    <form id="form2" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Visible="false">
            ...
            <Columns>
                <asp:HyperLinkField Text="Show" DataNavigateUrlFields="title" DataNavigateUrlFormatString="showProjectUnreg.aspx?titlename={0}" />
            </Columns>
        </asp:GridView>
    </form>
</body>
