...
namespace WebApplication3
{
    public partial class createProject : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cproj.createProject(title.Text,proj_description.Text,publicity.SelectedItem.Text,view_offer.SelectedItem.Text,category.SelectedItem.Text,subcategory.SelectedItem.Text,payment_method.SelectedItem.Text,maxprice.Text, devdur.SelectedItem.Text,offerduration.SelectedItem.Text,languages,user,creation_date);
